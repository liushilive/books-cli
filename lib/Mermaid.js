...
if (isWin) {
    var binPath = path.join(__dirname, '../node_modules/.bin/mmdc.cmd');
} else {
    var binPath = path.join(__dirname, '../node_modules/.bin/mmdc');
}
...
module.exports = { string2svgAsync, binPath, processMermaidBlockList };